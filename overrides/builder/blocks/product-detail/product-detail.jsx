...
// This component is largely the same as the Product Detail page, but with default recommenders removed and an explicit prop for the product info
const ProductDetail = ({productRef}) => {
    ...
    const productId = productRef?.options?.product
    const {
        data: product,
    ...
    return (
        ...
        >
            ...
            {/* largely the same as the Product Detail page, but default recommenders removed */}
        </Box>
    )
}
